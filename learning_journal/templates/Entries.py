...
class Entry(Base):
	...
	title = Column(convert_unicode = True, unicode_error = False, max_length = 255, unique = True)
	body_text = Column(convert_unicode = True, unicode_error = None,length = None )
	date_created = Column(date)
    date_ edited = Column(date)
